...
@section('content')
    <div class="container text-end">
        ...
        <form action="{{ route('products.update', $product->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                <label>الكمية في المحل </label>
                <input type="number" name="quantity_shop" class="form-control"
                    value="{{ old('quantity_shop', $product->quantity_shop) }}" min="0" required>


            </div>
            <div class="mb-3">
                <label>الكمية في المخزن</label>
                <input type="number" name="quantity_store" class="form-control"
                    value="{{ old('quantity_store', $product->quantity_store) }}" min="0" required>
            </div>
            <div class="mb-3">
